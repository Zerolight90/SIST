...
public class Ex6_addDialog extends JDialog {
	...
	JTextField empno_tf, add_item, ename_tf, pos_tf, hdate_tf, deptno_tf;
	...
	public Ex6_addDialog(Ex6_Frame f) {
		...
		ok_bt.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				String depno = deptno_tf.getText().trim();
				
				f.addData(empno, ename, pos, hdate, depno); //Ex6_Frame에 있는  ArrayList에 사원객체를 저장 후 JTable에 표현하고 돌아 온다.
