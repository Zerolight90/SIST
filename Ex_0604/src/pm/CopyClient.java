			...
			try {
				...
				if (obj != null) {
					...
					case 5:
						...
						p3.cmd = 1;
						// 명단 수집
						p3.setUser_names(server.getNames());
						p3.setRoom_names(server.getRoomNames());

						server.sendProtocol(p3); // 접속자 모두에게 전달!
						break;
					}
				}
			} catch (Exception e) {
